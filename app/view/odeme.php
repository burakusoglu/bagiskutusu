...
<body>
    ...
    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
        ...
        <h3 class="odemeDetay">Ödeme Detayı</h3>
    ...
    <div class="input-group mb-6" style=" margin-bottom:40px;">
          ...
          <div class="input-group mb-6" style=" margin-bottom:40px;">
                    <input type="integer" id="k_mail"  class="form-control "  value="<?php echo $_COOKIE['formPara'] ?>" disabled>
                    <div class="input-group-append">
                      <button class="btn btn-outline-secondary" style="border-color:#ced4da;" type="button" id="button-addon2" ><i class="fas fa-lira-sign"></i></button>
                    </div>
          </div>
...
<div class="form-container cardInput active">
    <form action="" method="post">
        <div class="form-group">
            ...
            <input class="form-control" placeholder=" Kart Numarası" type="tel" name="number" required>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">Kart Sahibi Adı</label>
        ...
        <div class="form-group">
            ...
            <input class="form-control" placeholder="AY/YIL" type="tel" name="expiry" required>
        </div>
        <div class="form-group">
            <label for="exampleInputEmail1">CVC</label>
            <input class="form-control" placeholder="CVC" type="tel" name="cvc" required>
        </div>
        <div class="form-group text-center">
            <button type="submit" class="btn btn-success btn-block payment-btn" value="1" name="kartOnay">Onayla</button>
