...
if (!isset($_COOKIE['formPara']) ) {
    ...
    if (post('kartOnay')) {
        ...
        if (!$cardNumber || !$name || !$expiry || !$cvc) {
            $cardError = "Gerekli Alanları Doldurunuz";
        } else {
            if (strlen($cvc) != 3) {
                $cardError = "hatalı cvc";
            } else if (strlen($cardNumber) != 19) {
                $cardError = "hatalı number ";
            } else {
                                          ...
                                          <tr>
                                              <td>
                                                  <div style="margin:0 40px;padding:40px 0;border-bottom:1px solid #d3d3d3;max-width:600px!important;line-height:1.2;word-break:break-word;color:#4a4a56;font-size:16px">
                                                      ...
                                                      <br>
                                                      <br>
                                                      <b style="font-size:18px;font-weight:bold"> '. $_COOKIE['formPara'].' TL tutarında yapmış olduğunuz bağış için TEŞEKKÜR EDERİZ. </b>
                                                      <br>
